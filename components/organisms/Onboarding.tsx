...
const columns = [
  ...
  { name: "Joining Date", uid: "joiningDate", sortable: true },
...
interface OnboardingTable {
  data: Array<IOnboarding>;
  handleValues: (email: string) => {};
}
        ...
        return (
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown className="bg-background border-1 border-default-200">
              ...
              <DropdownMenu>
                <DropdownItem onClick={() => handleValues(user.email)}>
                  Values
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>

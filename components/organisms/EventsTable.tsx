...
const INITIAL_VISIBLE_COLUMNS = ["title", "date", "actions"];

type User = any;

interface EmployeesTable {
  eventsData: Array<IEvents>;
...
export default function EventsTable({
  ...
  const pages = Math.ceil(eventsData.length / rowsPerPage);
  ...
  }, [eventsData, filterValue, statusFilter]);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Total {eventsData.length} employees
          </span>
